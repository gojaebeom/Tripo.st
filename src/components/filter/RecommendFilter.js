...
function RecommendFilter(props){
    return(
    <React.Fragment>
        <div className="layout_grid">
            <div className="filter-v2">
                ...
                <div className="box_default filter-v2-center">
                    ...
                    <div className="box_default filter-v2-center-bottom">
                        <RecommendSearch 
                            lang={props.lang}
                            getSearchSpotList={props.getSearchSpotList}
                            searchFind={props.searchFind}
                            searchData={props.searchData}
                            changeSpotList={props.changeSpotList}
                        />
                    </div>
                </div>
